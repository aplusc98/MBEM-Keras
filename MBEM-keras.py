...
t_score, tes_score, labels = train(x_train, naive_agg, y_dummy,z, x_test, y_test)
print ("train error:  " + str(t_score))
print ("Test error:  " + str(tes_score))
#########################################################################################
...
t_score, tes_score, _ = train(x_train, algo_agg, y_dummy,z, x_test, y_test)
print ("train error:  " + str(t_score))
print ("Test error:  " + str(tes_score))
##########################################################################################
